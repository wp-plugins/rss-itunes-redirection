	...
	*/
	...
	function settings_page(){
		...
		<div class="wrap">
			...
			<?php
			echo '<div style="float: right; border: 1px solid black; padding: 20px; width: 300px;">';
			...
			echo '<p><g:plusone annotation="inline" href="http://social2business.com/index.php/wordpress-plugins/itunes-rss-redirection/"></g:plusone><script type="text/javascript">
			  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></p>';
			...
			<p><input name="Submit" type="submit" class="button-primary" value="<?php echo __('Check my feed with the W3C Feed Validator', 'itunes-rss-redirection'); ?>" /></p>
			</form>
		</div>
		<?php
	}
